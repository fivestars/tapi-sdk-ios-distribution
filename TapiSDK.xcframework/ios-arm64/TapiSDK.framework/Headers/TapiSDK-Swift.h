...
#ifndef TAPISDK_SWIFT_H
#define TAPISDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TapiSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// The <code>TapiManager</code> is the heart and soul of the <code>TapiSDK</code>.
/// It provides all interactions with Tapi and thus cPay.
/// \code
/// // A normal interaction to process a transaction through `TapiSDK` would be as follows.
...
/// let configuration = TapiConfiguration(environment: .staging,
...
///
/// \endcode
SWIFT_CLASS("_TtC7TapiSDK11TapiManager")
